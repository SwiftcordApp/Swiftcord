...
public class RobustWebSocket: NSObject, ObservableObject {
	...
	private let log = Logger(subsystem: Bundle.main.bundleIdentifier ?? "DiscordAPI", category: "RobustWebSocket")
    ...
    private func connect() {
		...
		gatewayReq.setValue(DiscordAPI.getUserAgent(), forHTTPHeaderField: "User-Agent")
    ...
    private func handleMessage(message: String) {
        ...
        case .dispatchEvent:
            ...
            switch type {
            case .ready:
                guard let d = decoded.d as? ReadyEventData else { return }

...
public struct Guild: GatewayData, Identifiable, Equatable {
	...
	public init(id: Snowflake,
				...
				roles: [DecodableThrowable<Role>],
				emojis: [DecodableThrowable<Emoji>],
				features: [DecodableThrowable<GuildFeature>],
				mfa_level: MFALevel,
				application_id: Snowflake? = nil,
				system_channel_id: Snowflake? = nil,
				system_channel_flags: Int,
				rules_channel_id: Snowflake? = nil,
				joined_at: ISOTimestamp? = nil,
				large: Bool? = nil,
				...
				threads: [Channel]? = nil,
				presences: [PresenceUpdate]? = nil,
				max_presences: Int? = nil,
				max_members: Int? = nil,
				vanity_url_code: String? = nil,
				description: String? = nil,
				banner: String? = nil,
				premium_tier: PremiumLevel,
				...
				welcome_screen: GuildWelcomeScreen? = nil,
				nsfw_level: NSFWLevel,
				stage_instances: [StageInstance]? = nil,
				stickers: [Sticker]? = nil,
				guild_scheduled_events: [GuildScheduledEvent]? = nil,
...
public enum GuildScheduledEventPrivacyLvl: Int, Codable {
    case guild = 2
}
public enum GuildScheduledEventStatus: Int, Codable {
    case scheduled = 1
    case active = 2
    case completed = 3
    case cancelled = 4
...
public struct GuildScheduledEvent: Codable, GatewayData {
	...
	public let privacy_level: GuildScheduledEventPrivacyLvl
	public let status: GuildScheduledEventStatus
	public let entity_type: GuildScheduledEventEntityType

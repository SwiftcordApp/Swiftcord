...
public enum GatewayEvent: String, Codable {
    ...
    case guildSchEventCreate = "GUILD_SCHEDULED_EVENT_CREATE"
    case guildSchEventUpdate = "GUILD_SCHEDULED_EVENT_UPDATE"
    case guildSchEventDelete = "GUILD_SCHEDULED_EVENT_DELETE"
    case guildSchEventUserAdd = "GUILD_SCHEDULED_EVENT_USER_ADD"
    case guildSchEventUserRemove = "GUILD_SCHEDULED_EVENT_USER_REMOVE"
